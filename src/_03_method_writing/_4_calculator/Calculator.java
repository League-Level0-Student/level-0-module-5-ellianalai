...
public class Calculator {
	...
	public static float add(float num, float n) {
		return num+n;
	}
	public static float subtract(float num, float n) {
		return num-n;
	}
	public static float multiply(float num, float n) {
		return num*n;
	}
	public static float divide(float num, float n) {
		return num/n;
	}
	...
	public static void result(float number) {
		JOptionPane.showMessageDialog(null, "Your answer is " + number);
	}
